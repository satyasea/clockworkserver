...
$d = new DateTime($stamp, $zone);
var_dump($d->format(DATE_RFC822), $d->format('U'));
$zone = new DateTimeZone('America/New_York');
$d->setTimezone($zone);
var_dump($d->format(DATE_RFC822), $d->format('U'));
//$dt = new DateTime($phpstamp, $zone);
//echo "time from stamp" . $dt."<br>";
//$current_time = date("c");
//echo "time z chg " . $current_time."<br>";
*/
echo "tmzone ".date_default_timezone_get()."<br>";
