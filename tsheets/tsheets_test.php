...
foreach($users['results']['users'] as $user) {
    print("User[ {$user['first_name']} {$user['last_name']} {$user['id']}]<br>");  
}
...
$headr[] = "Authorization: Bearer ".$access_token;
     $ch = curl_init("https://rest.tsheets.com/api/v1/timesheets?start_date=2014-08-01&end_date=2014-08-07&on_the_clock=both");
